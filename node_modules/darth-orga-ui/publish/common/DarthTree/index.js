  ...
  var _loop = function loop() {
    ...
    return data.map(function (item, index) {
      ...
      if (item.children && item.children.length) {
        return /*#__PURE__*/_react["default"].createElement("li", {
        ...
        }, isExpandedTree(item.id) ? /*#__PURE__*/_react["default"].createElement(_icons.CaretDownOutlined, {
          onClick: function () {
          ...
          className: clickKey === item.id ? 'darth-tree-node' + ' darth-tree-active' : 'darth-tree-node',
          onClick: function () {
            (0, _newArrowCheck2["default"])(this, _this6);
          ...
          style: {
            display: item.children && item.children.length ? 'none' : 'block'
          }
        }, /*#__PURE__*/_react["default"].createElement("span", {
          onClick: function () {
            (0, _newArrowCheck2["default"])(this, _this6);
          ...
          className: !isExpandedTree(item.id) ? 'darth-tree-node-hidden' : null
        }, _loop(item.children)));
      }
...
(function () {
  ...
  reactHotLoader.register(DarthTree, "DarthTree", "/Users/mahai/Desktop/darth-platform-ui/packages/darth-orga-ui/src/common/DarthTree/index.js");
  reactHotLoader.register(_default, "default", "/Users/mahai/Desktop/darth-platform-ui/packages/darth-orga-ui/src/common/DarthTree/index.js");
})();
